...
module Example = struct
  ...
  let output_example () =
    let bass = Music_xml.create_instrument 0 Music_xml.MidiInstruments.std5_bass std5_bass [first_bass_riff ()] in
    let guitar = Music_xml.create_instrument 1 Music_xml.MidiInstruments.std_guitar std_guitar [first_guitar_riff ()] in
